  ...
  return (
    <>
      ...
      <aside
        ...
        tabIndex={-1}
        className={`lg:hidden fixed inset-y-0 left-0 z-50 w-80 max-w-[88vw] bg-white shadow-xl transform transition-transform duration-200 ease-in-out overflow-y-auto ${
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-primary-50">
          <h2
            ...
            style={{ fontFamily: "var(--ba-font-display)" }}
          >
            Filters
          </h2>
          <button
