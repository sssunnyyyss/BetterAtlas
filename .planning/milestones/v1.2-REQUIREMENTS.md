# Requirements Archive: v1.2 Conversational Atlas-Grounded Chat

**Archived:** 2026-03-07
**Status:** SHIPPED

For next-milestone requirements, run `$gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
